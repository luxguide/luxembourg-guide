...
Этот маршрут не приводит к примечательному водопаду Schiessentümpel (именно его обычно можно увидеть на всех фотографиях региона). Вот примерн маршрута с ним: https://www.komoot.com/smarttour/1555988. 
...
Fond-de-Gras: ж/д станция, сохраненная в оригинальном состоянии. Работает по определенным дням недели, внимательно смотрите расписание (но к сожалению оно не очень понятное). Концентрирует в себе сразу много активностей:
	...
	2) От Fond-de-Gras до станции Pétange курсируют паровозы и/или другие винтажные поезда
	3) От Fond-de-Gras по горным туннелям курсирует электропоезд. Выезжает с другой стороны горы и через какое-то время возвращается
	4) Так же можно покататься на велобайке
